...
from app.handlers import start, help as help_handler, email, inbox, otp, admin
...
def build_application() -> Application:
    ...
    application.add_handler(CallbackQueryHandler(inbox.inbox_callback, pattern=r"^email:inbox:"))
    application.add_handler(CallbackQueryHandler(inbox.refresh_callback, pattern=r"^email:refresh:"))
    application.add_handler(CallbackQueryHandler(otp.get_otp_callback, pattern=r"^email:otp:"))
    application.add_handler(CallbackQueryHandler(inbox.read_email_callback, pattern=r"^msg:read:"))
